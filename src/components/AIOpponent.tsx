...
export const AIOpponent: React.FC<AIOpponentProps> = ({ onStartGame, isPlaying }) => {
  ...
  return <section className="panel ai-opponent ai-opponent-v2" aria-labelledby="ai-opponent-title">
    ...
    <div className="ai-current-settings"><span><strong>{selectedDifficulty.label}</strong><small>{t('ai.difficultyLabel')}</small></span><span><strong>{colorLabel}</strong><small>{t('ai.playingAsLabel')}</small></span></div>
